...
import com.example.projemanag.databinding.DialogeSearchMemberBinding
...
class MembersActivity : BaseActivity() {
    ...
    fun setupMembersList(list: ArrayList<User>) {
        ...
        val adapter = MembersListItemsAdapter(this, mAssignedMembersList)
    ...
    private fun dialogSearchMember() {
        val binding: DialogeSearchMemberBinding = DialogeSearchMemberBinding.inflate(layoutInflater)
